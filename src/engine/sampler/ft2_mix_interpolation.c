...
#include <stdio.h>
#include <math.h>
/* ft2_header.h + ft2_video.h dropped — only PI + showErrorMsgBox were
 * referenced. Provide local stubs. */
#ifndef PI
#define PI 3.14159265358979323846
#endif
static void showErrorMsgBox (const char *msg) { fprintf (stderr, "[sampler] %s\n", msg); }
